  ...
  return (
    <div className="flex min-h-screen bg-zinc-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-32 left-24 animate-float" style={{ animationDelay: '2s' }}>
          <div className="rounded-2xl bg-emerald-500/10 border border-emerald-500/20 backdrop-blur-sm p-4">
        ...
        <div className="absolute bottom-1/4 left-1/3 w-48 h-48 bg-emerald-500/8 rounded-full blur-3xl" />
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24">
          <div className="animate-slide-up">
            ...
            <h2 className="text-4xl xl:text-5xl font-bold text-zinc-100 leading-tight mb-6">
              ...
              <span className="text-emerald-400">one problem at a time.</span>
            </h2>

            <p className="text-lg text-zinc-400 mb-10 max-w-md leading-relaxed">
              The modern platform for practicing data structures and algorithms with real-time feedback and guided solutions.
            </p>
        ...
        <div className="w-full max-w-md animate-slide-up">
          ...
          <div className="rounded-2xl border border-zinc-800/60 bg-zinc-900/40 backdrop-blur-xl p-8 shadow-2xl shadow-black/20">
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm text-zinc-500">Sign in to continue your progress</p>
            </div>
