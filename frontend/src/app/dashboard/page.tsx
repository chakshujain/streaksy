    ...
    <AppShell>
      <PageTransition>
        <div className="space-y-8">
          ...
          {/* Stats Cards */}
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 animate-slide-up" style={{ animationDelay: '75ms', animationFillMode: 'both' }}>
            <StatsCards streak={streak} solvedCount={solvedCount} loading={statsLoading} />
          </div>

          {/* Streak + Quick Stats row */}
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 animate-slide-up" style={{ animationDelay: '150ms', animationFillMode: 'both' }}>
            {/* Streak Highlight */}
            <Card
