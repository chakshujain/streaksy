...
- `/dashboard` — Command center: stats, today's tasks, active roadmaps, feed, groups, friends widget, leaderboard peek, extension banner, heatmap
...
- `/settings` — User preferences, LeetCode extension section, Google Calendar, notifications
